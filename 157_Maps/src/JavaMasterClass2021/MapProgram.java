...
public class MapProgram {
    ...
    public static void main(String[] args) {
        ...
        // if u use reserved name like in Class name - Map
...
//        System.out.println(languages.put("Java", "1st Java text is rewritten"));
//        languages.put("Java", "1st Java text is rewritten");
//        System.out.println(languages.get("Java"));
...
//                "with imperative features"));
        if (languages.replace("Lisp", "Therein lies madness", "a functional programming " +
